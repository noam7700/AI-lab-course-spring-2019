...
void StringGene::mutate(Mutate_type mutype /*= MUTATE_DEFAULT*/){
    if(mutype != MUTATE_DEFAULT){
        cout << "Error: StringGene doesn't support this Mutate_type\n";
        throw;
    }
...
void StringGene::setMate(Gene& p1, Gene& p2, Crossover_type xtype /*= CROSSOVER_DEFAULTX*/){
    if(xtype != CROSSOVER_DEFAULTX){
        cout << "Error: StringGene doesn't support this Mutate_type\n";
        throw;
    }
